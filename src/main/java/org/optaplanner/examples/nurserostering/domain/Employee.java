...
public class Employee  extends PObject{
    ...
    @JsonProperty("dayOffRequestMap")
    @JsonDeserialize(keyUsing=ShiftDateDeserialize.class)
    private Map<ShiftDate, DayOffRequest> dayOffRequestMap;

    @JsonProperty("dayOnRequestMap")
    @JsonDeserialize(keyUsing=ShiftDateDeserialize.class)
    private Map<ShiftDate, DayOnRequest> dayOnRequestMap;

    @JsonProperty("shiftOffRequestMap")
    @JsonDeserialize(keyUsing=ShiftDeserialize.class)
    private Map<Shift, ShiftOffRequest> shiftOffRequestMap;

    @JsonProperty("shiftOnRequestMap")
    @JsonDeserialize(keyUsing=ShiftDeserialize.class)
